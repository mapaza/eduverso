...
import IframeLab from 'components/iframe-lab';
  ...
  return (
    <Box sx={styles.boostAgencies}  id="boost-agencies">
      <Container>
        <Box sx={styles.row}>
        <Flex sx={styles.col}>
          <IframeLab as ="video" sx={styles.iframe}/> 
...
const styles = {
  boostAgencies: {
    pt: ['70px', '70px', '80px', '90px', '52px', '120px', '130px'],
    pb: ['70px', '70px', '80px', '90px', '52px', '120px', '130px'],
    height:'100vh'
  },
  row: {
    display: 'flex',
  ...
  content: {
    ...
    pt: [null, null, null, null, null, '34px'],
